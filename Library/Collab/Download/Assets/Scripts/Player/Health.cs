...
public class Health : MonoBehaviour {
    ...
    {
        int displaydamage;
        displaydamage = damage / H_Health;
        H_UpdateHealth(displaydamage);
    ...
    public void H_UpdateHealth(float DamagePercent)
    {
        H_Healthbar.HB_UpdateHealth(DamagePercent);
    }

	public void H_PlayerTakeDamage(int Damage)
	{
